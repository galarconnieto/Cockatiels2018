...
# ## Define functions for removing camera lens distortion
...
##
##
### ## Define function for adding border back to barcodes
##
### In[ ]:
...
def decode(working_dir, working_file):
    ...
    tags.load_dict("/home/gustavo/Cockatiels/SCRIPTS_2020/master_list_outdoor.pkl")

    print tags.loaded # check if they properly loaded
    ...
    data_dir_csv = '/home/gustavo/Cockatiels/CSV/'
    ...
    # ## Run main loop, press `esc` to stop
    ...
    while cap.isOpened():  
        ...
        if ret:
            ...
            #thresh = get_threshold(gray, block_size = 201, offset = -20)
            ...
            for cnt in contours:
                ...
                if cnt_shape[0] >= 4: # only look at contours that could be tags
                    ...
                    if -10 > area > -2000: # check area
                        ...
                        cnt_x = cnt_reshape[:,0]
                        cnt_y = cnt_reshape[:,1]#COCKATIELS
                        flat = cnt.flatten()
...
#working_dir = "/home/gustavo/Cockatiels/VIDEOS/"
#working_file = "Cockatiels_2018-06-16"
