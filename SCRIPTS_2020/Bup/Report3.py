...
for i in pis: # (0, (len(ip_pi_-1): #use this for more than one pi
    ...
    if files1 != files2:
        ...
        #img.show()
        with open('/home/gustavo/COCKATIELS/REPORTS/report.csv' ,'a') as fd:
            fd.write(message)
        
        #texto = (str("cat \"" + message + "\" >> /home/gustavo/COCKATIELS/REPORTS/text"))
        #print(texto)
        #terminal(texto)
        #emailme= str("mpack -s Loros -d /home/gustavo/COCKATIELS/REPORTS/report.csv /home/gustavo/COCKATIELS/REPORTS/" + last_photo + " galarconnieto@orn.mpg.de")
        #print(emailme)
        #terminal(emailme)
    else:
