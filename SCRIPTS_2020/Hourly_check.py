...
with open('/home/gustavo/TITS/' + timest + '.csv', "wb") as file_new:
    count = 0
    ...
    for i in range(0, (len(ip_pi))):  # (0, (len(ip_pi_-1): #use this for more than one pi
        ...
        if "python" not in processes1:
            ...
            #print(rebooting)
            terminal(rebooting)
            message = (str(pi_name[i] + " WAS REBOOTED!. Total videos = ") + str(files1))
	    ...
	    count = count + 1
            ...
            #message = (str(pi_name[i] + " is working. Total videos = ") + str(files1))
            #f= open('/home/gustavo/TITS/' + timest + '.csv', "a+")
            #f.write(message + "\n")
            #f.close()
